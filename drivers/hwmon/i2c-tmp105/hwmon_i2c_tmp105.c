...
/*
 * hwmon_i2c_tmp105.c - TMP105/LM75 兼容 I2C 温度传感器驱动（hwmon）
 *
 * 命名遵循 doc/开发规范.md：drivers/<子系统>/<总线>-<器件>/
 * 本驱动属 hwmon/i2c、器件 tmp105，模块名 hwmon_i2c_tmp105。
 *
...
/*
 * 模块名：决定 .ko 名与 /sys/bus/i2c/drivers/hwmon_i2c_tmp105
 * 注意：hwmon 对外 name 仍是 "tmp105"（用户态 ABI），
 * 不随模块名变化（见 doc/开发规范.md §1.3）。
 */
#define DRIVER_NAME		"hwmon_i2c_tmp105"
...
static const struct hwmon_ops hwmon_i2c_tmp105_ops = {
