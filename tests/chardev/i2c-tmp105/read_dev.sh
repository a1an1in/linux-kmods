...
# 用法：
#   ./read_dev.sh                          # 模块已加载
#   ./read_dev.sh /mnt/drivers/chardev/i2c-tmp105/chardev_i2c_tmp105.ko
#   IOCTL_TEST=/mnt/tests/chardev/i2c-tmp105/build/ioctl_test ./read_dev.sh
#
# 教学点：
...
DEV=${DEV:-/dev/tmp105}
IOCTL_TEST=${IOCTL_TEST:-/mnt/tests/chardev/i2c-tmp105/build/ioctl_test}
...
echo
echo "提示："
echo "  - 与 hwmon 驱动共存：insmod hwmon_i2c_tmp105.ko 后，"
